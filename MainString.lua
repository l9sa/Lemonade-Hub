    ...
    game:GetService("RunService").RenderStepped:Connect(function()GetKey.Position=Vector2.new(workspace.CurrentCamera.ViewportSize.X/2-100,workspace.CurrentCamera.ViewportSize.Y/2)end)
    wait(1)
    ...
    LoginButton.MouseButton1Click:Connect(function()
        ...
        if password == "lCYehIdOnTEdatPZnumbers" then
            ...
            game:GetService("RunService").RenderStepped:Connect(function()InvalidKey.Position=Vector2.new(workspace.CurrentCamera.ViewportSize.X/2-100,workspace.CurrentCamera.ViewportSize.Y/2)end)
            wait(1.5)
            InvalidKey:Remove()
        end
    end)
...
while getgenv().KeyUnlocked do
    ...
    game:GetService("RunService").RenderStepped:Connect(function()Gui.Position=Vector2.new(workspace.CurrentCamera.ViewportSize.X/2-100,workspace.CurrentCamera.ViewportSize.Y/2)end)
    wait(3)
    Gui:Remove()
